...
//	motor_setting.low_level_kalman_on = 0;
	...
	memcpy(&memArr22[7], &FrictionCompObj.Epsilon,                               sizeof(FrictionCompObj.Epsilon));
	IOIF_WriteFlash(writeAddr, memArr22);
	writeAddr += 32;

	memcpy(&memArr23[0], &FrictionCompObj.mu_C,                                  sizeof(FrictionCompObj.mu_C));
	memcpy(&memArr23[1], &FrictionCompObj.mu_V,                                  sizeof(FrictionCompObj.mu_V));
	memcpy(&memArr23[2], &motor_setting.low_level_current_LPF_on,                sizeof(motor_setting.low_level_current_LPF_on));
...
void DownloadProperties()
{
  ...
  IOIF_ReadFlash(readAddr, &impedanceCtrl.opt1_i_buffer.Kd_target,                 IOIF_FLASH_READ_SIZE_4B); readAddr += IOIF_FLASH_READ_ADDR_SIZE_4B;
    ...
    IOIF_ReadFlash(readAddr, &kf_current_object.kf_R,                              IOIF_FLASH_READ_SIZE_4B); readAddr += IOIF_FLASH_READ_ADDR_SIZE_4B;
    ...
    IOIF_ReadFlash(readAddr, &FrictionCompObj.Epsilon,                              IOIF_FLASH_READ_SIZE_4B); readAddr += IOIF_FLASH_READ_ADDR_SIZE_4B;

    for(int i = 0; i<500; ++i){}

    IOIF_ReadFlash(readAddr, &FrictionCompObj.mu_C,                                 IOIF_FLASH_READ_SIZE_4B); readAddr += IOIF_FLASH_READ_ADDR_SIZE_4B;
    IOIF_ReadFlash(readAddr, &FrictionCompObj.mu_V,                                 IOIF_FLASH_READ_SIZE_4B); readAddr += IOIF_FLASH_READ_ADDR_SIZE_4B;
    IOIF_ReadFlash(readAddr, &motor_setting.low_level_current_LPF_on,               IOIF_FLASH_READ_SIZE_4B); readAddr += IOIF_FLASH_READ_ADDR_SIZE_4B;
  /********************** Send Data for Synchronization With UI ***************************/
    uint16_t t_identifier;
      ...
      memcpy(&temp_arr[10], &motor_setting.low_level_current_LPF_on, 	 sizeof(motor_setting.low_level_current_LPF_on));    temp_arr_index++;
      ...
      memcpy(&temp_arr[5],  &FrictionCompObj.Epsilon,                          sizeof(FrictionCompObj.Epsilon));                       temp_arr_index++;
      memcpy(&temp_arr[6],  &FrictionCompObj.mu_C,                             sizeof(FrictionCompObj.mu_C));                          temp_arr_index++;
      memcpy(&temp_arr[7],  &FrictionCompObj.mu_V,                             sizeof(FrictionCompObj.mu_V));                          temp_arr_index++;
