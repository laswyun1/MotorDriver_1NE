...
void Create_SDOTable_ObjDictionary(void)
{
	...
	Assemble_SDO( &SDO_Table [TASK_ID_LOWLEVEL] [SDO_ID_LOWLEVEL_CURRENT_LPF_ONOFF],            UINT8_T);
...
void Create_PDOTable_ObjDictionary(void)
{
	...
	Assemble_PDO( (PDOinfo*)PDO_Table [TASK_ID_WIDM] [PDO_ID_WIDM_TENSION_P],  		FLOAT32_T,  	1);
